...
function kliqqi_createtables($conn) {
	...
	('modules_update_url','http://kliqqi.com/mods/version-update.txt'),
	('kliqqi_update',''),
	...
	('Sidebar Stories', 2.1, 0, 'sidebar_stories', 1,0),
	('Sidebar Comments', 2.0, 0, 'sidebar_comments', 1,0),
